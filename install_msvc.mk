...
#  (note) [16Oct2018] superceded by tkopengl/lpng1632/ in windows build
#
...
#VCTK=c:/Program Files/Microsoft Visual Studio 8/VC

# use the path exported by "setenv_msvc.sh"
VCTK=$(VCTK_MSYS)


#
# Windows SDK path prefix
#  (note) this is usually set by "setenv_msvc.sh"
#
...
#  (note) this is usually set by "setenv_msvc.sh"
#
##WINSDK_VER=10.0.10240.0
#WINSDK_VER=10.0.14393.0
##WINSDK_VER=10.0.16299.0
...
#
WINSDK_INC_UCRT=$(WINSDK_PATH)/Include/$(WINSDK_VER)/ucrt/
ifeq ($(BUILD_64),y)
WINSDK_LIB_UCRT=$(WINSDK_PATH)/Lib/$(WINSDK_VER)/ucrt/x64/
else
WINSDK_LIB_UCRT=$(WINSDK_PATH)/Lib/$(WINSDK_VER)/ucrt/x86/
endif

WINSDK_INC_SHARED=$(WINSDK_PATH)/Include/$(WINSDK_VER)/shared/
...
#W32API_INC=C:/Program Files (x86)/Windows Kits/10/Include/10.0.14393.0/um
W32API_INC=$(WINSDK_PATH)/Include/$(WINSDK_VER)/um
ifeq ($(BUILD_64),y)
#W32API_LIB=C:/Program Files (x86)/Windows Kits/10/Lib/10.0.16299.0/um/x64
#W32API_LIB=C:/Program Files (x86)/Windows Kits/10/Lib/10.0.14393.0/um/x64
W32API_LIB=$(WINSDK_PATH)/Lib/$(WINSDK_VER)/um/x64
else
#W32API_LIB=C:/Program Files (x86)/Windows Kits/10/Lib/10.0.16299.0/um/x86
W32API_LIB=$(WINSDK_PATH)/Lib/$(WINSDK_VER)/um/x86
endif
else
...
# vs2019:
SHARED_MSVCRT_LDFLAGS = -LIBPATH:"$(VCTK)/lib/x64" -LIBPATH:"$(W32API_LIB)" 
else
